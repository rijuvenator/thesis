%%%%%
\chapter{Study of neutron-induced background hits in the CMS endcap muon system, and implications for the HL-LHC}
...
\begin{figure}[p]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/fig_CSC.pdf}
...
\begin{figure}[p]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/fig_CSC_electronics.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/neutronSpectrum_before.pdf}\\
	\includegraphics[width=\dummyFigWidth]{figures/neutronSpectrum_after.pdf}
	\caption{Histogram of neutron kinetic energy just before nuclear capture, (\posstyle{top}) before and (\posstyle{bottom}) after enabling thermal treatment of detector nuclei. The dashed line indicates 0.025\unit{eV}. Before enabling the new feature, the low energy peak of captured neutrons is several orders of magnitude below thermal energies; after enabling the feature, the low energy peak is at thermal energies. Also visible are the resonant capture peaks on, for example, \chem{56}{Fe}, in the \keVns range.}
	\label{fig:nKE}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/LastEvsTOF.pdf}\\
	\includegraphics[width=\dummyFigWidth]{figures/LastEvsTOF_All.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/hrzTot_sim_nCapture.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/neut_gamma_proc_energy.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/CornerSelection.pdf}
...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/BXstructure.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/Rainbow_wire_11.pdf}
...
\begin{table}
	\centering
	\topcaption{Enumeration of time windows used for each region in \FigDot~\ref{fig:rainbow}, listed by digi readout time bins and bunch places after the gap.}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/dppdt_vs_L.png}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/lumi_vs_pu_allfills.png}
...
We thus obtain $N_\text{hits}^\text{CMS}(c, d, \mathcal{L})$
...
Finally, we convert \Eq~\ref{eqn:MC_hits_perA_perPP_perDigi} and \ref{eqn:MC_hits_perA_perPP_perCSC} to per time quantities by choosing a reference luminosity $\mathcal{L}_0$ and multiplying by the \pp collision rate per time at that luminosity, $N_\text{\pp}^\text{MC}/t$:
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_11_wire_early_AREA_TIME_LOOK_20180628_fit.pdf}
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_11_wire_total_AREA_TIME_LOOK_20180628_fit.pdf}
	\caption{Plot of hits per time per area as a function of luminosity as calculated in \Eq~\ref{eqn:hits_perA_perT_perCSC_Lumi} for ME1/1 chambers, (\posstyle{top}) for hits that occur at the end of LHC gaps (candidate neutron capture induced hits) and (\posstyle{bottom}) for hits that occur during \pp collisions. The red line is a linear fit constrained to go through the origin and fit over the central region of luminosity.}
	\label{fig:lumi_11}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_21_wire_early_AREA_TIME_LOOK_20180628_fit.pdf}
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_21_wire_total_AREA_TIME_LOOK_20180628_fit.pdf}
	\caption{Plot of hits per time per area as a function of luminosity as calculated in \Eq~\ref{eqn:hits_perA_perT_perCSC_Lumi} for ME2/1 chambers, (\posstyle{top}) for hits that occur at the end of LHC gaps (candidate neutron capture induced hits) and (\posstyle{bottom}) for hits that occur during \pp collisions. The red line is a linear fit constrained to go through the origin and fit over the central region of luminosity.}
	\label{fig:lumi_21}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/occupancy_11_wire_early_AREA_TIME_20180628_XS_ThermalON.pdf}
	\includegraphics[width=\dummyFigWidth]{figures/occupancy_11_wire_early_AREA_TIME_20180628_HP_ThermalON.pdf}
	\caption{Histogram of neutron capture induced anode wire hits per time per area for CMS data (as calculated in \Eq~\ref{eqn:hits_perA_perT_perDigi}) and for MC simulation (as calculated in \Eq~\ref{eqn:MC_hits_perA_perT_perDigi}) for ME1/1 chambers for a reference luminosity of \reflumi. CMS data are compared to results from \GEANTfour (\posstyle{top}) XS and (\posstyle{bottom}) HP neutron interaction cross section libraries in CMS MC simulation of minimum-bias proton-proton collisions at 13 TeV.}
	\label{fig:wg_occupancy_11}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/occupancy_21_wire_early_AREA_TIME_20180628_XS_ThermalON.pdf}
	\includegraphics[width=\dummyFigWidth]{figures/occupancy_21_wire_early_AREA_TIME_20180628_HP_ThermalON.pdf}
...
%\begin{figure}[htbp]
%	\centering
%	\includegraphics[width=\dummyFigWidth]{figures/Eff_11_withTight.pdf}
%	\includegraphics[width=\dummyFigWidth]{figures/Eff_21_withTight.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/ED_GIF_3384_ME21_9.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/RH_GIF_3384_ME21_9.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.9\dummyFigWidth]{figures/SegNHitsFrac_ME11_all.pdf}
	\includegraphics[width=.9\dummyFigWidth]{figures/SegNHitsFrac_ME21_all.pdf}
	\caption{Stacked plot of fraction of offline reconstructed muon segments, categorized by the number of reconstructed hits used to form them, \vs chamber anode HV current, for the (\posstyle{top}) ME1/1 and (\posstyle{bottom}) ME2/1 at GIF++. As the source intensity is increased (chamber anode HV current is increased), the fraction of good quality 6 hit segments decreases, while the fraction of lower quality 3 hit segments increases. The white line indicates an approximate equivalent HV current corresponding to design HL-LHC luminosity.}
	\label{fig:seg_frac}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\twoThirdsFigWidth]{figures/ME11_N_31_5_f5394_curr_lumi.pdf}
	\includegraphics[width=\twoThirdsFigWidth]{figures/ME11_P_02_2_f5394_curr_lumi.pdf}
	\includegraphics[width=\twoThirdsFigWidth]{figures/ME11_P_18_2_f5394_curr_lumi.pdf}
	\caption{Plot of anode HV current \vs LHC luminosity with a two-parameter linear fit for (\posstyle{top}) a well-behaved ME1/1 channel, (\posstyle{middle}) an ME1/1 channel with a large fitted offset, and (\posstyle{bottom}) a noisy ME1/1 channel.}
	\label{fig:ME11_IvsL}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/me11_fill_5394_a_sel_slope_hist.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_11_wire_early_CHAM_TIME_20180416_fit.pdf}
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_11_wire_total_CHAM_TIME_20180416_fit.pdf}
	\caption{Plot of ME1/1 wire group ${N}^\text{CMS}_\text{hits} / {t}$ \vs LHC luminosity with a one-parameter linear fit for hits that occur (\posstyle{top}) during LHC bunch gaps and (\posstyle{bottom}) during \pp collisions.}
	\label{fig:ME11_HvsL}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=\twoThirdsFigWidth]{figures/ME21_P_04_1_5_f5394_curr_lumi.pdf}
    \includegraphics[width=\twoThirdsFigWidth]{figures/ME21_P_04_2_5_f5394_curr_lumi.pdf}
    \includegraphics[width=\twoThirdsFigWidth]{figures/ME21_P_04_3_5_f5394_curr_lumi.pdf}
\caption{Plot of current \vs luminosity for ME+2/1/04 layer 5 for HV Segment (\posstyle{top}) 1, (\posstyle{middle}) 2, and (\posstyle{bottom}) 3, with a two-parameter linear fit. The least count of approximately 0.1\muA is most evident in HV segment 3.}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_21_wire_early_CHAM_TIME_20180416_fit.pdf}
	\includegraphics[width=\dummyFigWidth]{figures/luminosity_21_wire_total_CHAM_TIME_20180416_fit.pdf}
	\caption{Plot of ME2/1 wire group ${N}^\text{CMS}_\text{hits}/{t}$ \vs LHC luminosity for hits that occur (\posstyle{top}) during LHC bunch gaps and (\posstyle{bottom}) during \pp collisions, with a one-parameter linear fit.}
	\label{fig:ME21_HvsL}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/occupancy_21_wire_total_CHAM_TIME_20180416.pdf}
...
The next step we take is to convert the luminosity values of all points in \FigDot~\ref{fig:ME21_curr_lumi_p214_5} to equivalent \unit{hits/s}. To do this, we multiply the luminosity value of each point, denoted $\mathcal{L}$, by the \unit{hits/s} at \reflumi, $H_{\text{WG-ME2/1-}s}$, in each HV segment.
...
\begin{figure}
	\centering
	\includegraphics[width=\twoThirdsFigWidth]{figures/ME21_P_04_5_f5394_curr_hitrate.pdf}
	\includegraphics[width=\twoThirdsFigWidth]{figures/ME21_P_04_6_f5394_curr_hitrate.pdf}
	\caption{Plot of HV current \vs\unit{hits/s} for a ME2/1 layer (\posstyle{top}) with smooth transitions in current and\unit{hits/s} between HV segments and (\posstyle{bottom}) Plot of HV current \vs\unit{hits/s} for a ME2/1 layer with a jump in HV current and\unit{hits/s} between HV segments 1 and 2. Segment 1 is in blue, segment 2 is in green, and segment 3 is in red.}
	\label{fig:ME21_IvsH}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/ME21_f5394_chph_sel_hist.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\halfFigWidth]{figures/g_ALL_C1.pdf}\hspace*{-1em}
	\includegraphics[width=\halfFigWidth]{figures/g_S1_C110.pdf}
	\includegraphics[width=\halfFigWidth]{figures/g_S2_C110.pdf}\hspace*{-1em}
	\includegraphics[width=\halfFigWidth]{figures/g_S3_C110.pdf}
	\caption{Plot of anode HV current \vs\unit{hits/s} at GIF++ for (\posstyle{top left}) ME1/1 and ME2/1 HV segment (\posstyle{top right}) 1, (\posstyle{bottom left}) 2, and (\posstyle{bottom right}) 3.}
	\label{fig:GIF_IvsH}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=\dummyFigWidth]{figures/CPH_ME11.pdf}
	\includegraphics[width=\dummyFigWidth]{figures/CPH_ME21.pdf}
	\caption{In simulation of CMS data, histogram of the avalanche charge per simulated wire hit for (\posstyle{top}) ME1/1 and (\posstyle{bottom}) non-ME1/1 chambers}
	\label{fig:cph_MC}
\end{figure}
