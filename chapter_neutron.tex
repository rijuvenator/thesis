...
The text and plots in this appendix were written and produced together with Christian Schnaible and Bob Cousins and form the internal detector note CMS DN-2017/019.
The work was presented by me at the 2017 European Physical Society Conference on High-Energy Physics (EPS-HEP) and by Christian Schnaible at the 2017 American Physical Society Meeting of the Division of Particles \& Fields (APS-DPF).
The EPS-HEP poster, the associated proceedings, the APS-DPF parallel talk, and the repository of approved plots can be found at References~\cite{Dasgupta:Poster}, \cite{Dasgupta:Proceedings}, \cite{Schnaible:Talk}, and \cite{NeutronTwiki}.
