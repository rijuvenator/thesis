...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/LHCAcceleratorComplex.pdf}
...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/InjectionChain.pdf}
...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/Fill5423BunchPattern.png}
...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/RFBucket.pdf}
...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=0.55\textwidth]{figures/DipoleCrossSection.jpeg}
  \includegraphics[width=0.35\textwidth]{figures/FieldLines.jpg}
...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/CMSIntLumi.pdf}
...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/Sagitta.pdf}
...
\begin{figure}[tpb]
  \centering
  \includegraphics[width=\textwidth]{figures/MuonMomentumResolution.pdf}
